...
+ (id)rtpBroadcastStreamOutputWithSAPAnnounce:(NSString *)announceName
{
    ...
    id output = [self streamOutputWithOptionDictionary:@{@"rtpOptions":         @{@"muxer": @"ts",
                                                                                  @"access": @"file",
                                                                                  @"sdp": @"sdp",
                                                                                  @"sap": @"sap",
                                                                                  @"name": name,
...
{
    return [self streamOutputWithOptionDictionary:@{@"transcodingOptions": @{@"videoCodec": @"h264",
                                                                             @"videoBitrate": @"1024", // max by Apple: 1.5 mbps
                                                                             @"audioCodec": @"mp3",
                                                                             @"audioBitrate": @"128", // max by Apple: 160 kbps
                                                                             @"channels": @"2",
                                                                             @"width": @"640", // max by Apple: do.
                                                                             @"height": @"480", // max by Apple: do.
                                                                             @"audio-sync": @"Yes"},
                                                    @"outputOptions": @{@"muxer": @"mp4",
                                                                        @"access": @"file",
...
{
    return [self streamOutputWithOptionDictionary:@{@"transcodingOptions": @{@"videoCodec": @"mp4v",
                                                                             @"videoBitrate": @"1024",
                                                                             @"audioCodec": @"mp4a",
                                                                             @"audioBitrate": @"192"},
                                                    @"outputOptions": @{@"muxer": @"mp4",
...
{
    return [self streamOutputWithOptionDictionary:@{@"outputOptions": @{@"muxer": @"ps",
                                                                        @"access": @"file",
                                                                        @"destination": [filePath copy]}}
            ];
}
...
{
    return [self streamOutputWithOptionDictionary:@{@"transcodingOptions": @{@"videoCodec": @"mp2v",
                                                                             @"videoBitrate": @"1024",
                                                                             @"audioCodec": @"mpga",
                                                                             @"audioBitrate": @"128",
                                                                             @"audio-sync": @"Yes"},
                                                    @"outputOptions": @{@"muxer": @"ps",
                                                                        @"access": @"file",
                                                                        @"destination": [filePath copy]}}
            ];
}
