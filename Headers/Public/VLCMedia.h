 ...
 */
@property (weak, readonly) VLCTime * length;
 ...
 */
@property (weak, readonly) VLCMediaList * subitems;
 ...
 */
@property (nonatomic, readonly) BOOL saveMetadata;
...
@property (nonatomic, getter=isMediaSizeSuitableForDevice, readonly) BOOL mediaSizeSuitableForDevice;
...
@property (nonatomic, readonly, copy) NSArray *tracksInformation;
 ...
 *
 */
@property (nonatomic, readonly, copy) NSDictionary *stats;
 ...
 */
@property (nonatomic, readonly) NSInteger numberOfDecodedVideoBlocks;
/**
 * returns the total number of decoded audio blocks in the current media session
 * \return a NSInteger with the total number of decoded blocks
 */
@property (nonatomic, readonly) NSInteger numberOfDecodedAudioBlocks;
 ...
 */
@property (nonatomic, readonly) NSInteger numberOfDisplayedPictures;
/**
 ...
 */
@property (nonatomic, readonly) NSInteger numberOfLostPictures;
 ...
 */
@property (nonatomic, readonly) NSInteger numberOfPlayedAudioBuffers;
/**
 * returns the total number of audio buffers lost during the current media session
 * \return a NSInteger with the total number of displayed pictures
 */
@property (nonatomic, readonly) NSInteger numberOfLostAudioBuffers;
 ...
 */
@property (nonatomic, readonly) NSInteger numberOfSentPackets;
/**
 ...
 */
@property (nonatomic, readonly) NSInteger numberOfSentBytes;
/**
 * returns the current bitrate of sent bytes
 * \return a float of the current bitrate of sent bits
 */
@property (nonatomic, readonly) float streamOutputBitrate;
/**
 ...
 */
@property (nonatomic, readonly) NSInteger numberOfCorruptedDataPackets;
/**
 ...
 */
@property (nonatomic, readonly) NSInteger numberOfDiscontinuties;
